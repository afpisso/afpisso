        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-20">
          ...
          <div>
            ...
            >
              ...
              <p
                className="mb-3"
                style={{ fontFamily: '"Play", sans-serif', color: 'var(--color-fg-dim)', fontSize: '11px', letterSpacing: '0.15em', textTransform: 'uppercase' }}
              >
            ...
            >
              <p
                ...
                style={{ fontFamily: '"Play", sans-serif', color: 'rgba(240,238,234,0.75)', fontSize: '15px', lineHeight: 1.8 }}
              >
                {about.bio1}
              </p>
              <p
                className="mb-5 leading-relaxed"
                style={{ fontFamily: '"Play", sans-serif', color: 'rgba(240,238,234,0.6)', fontSize: '14px', lineHeight: 1.85 }}
              >
                {about.bio2}
              </p>
              <p
              ...
              <CyberBtn variant="ghost" size="sm" to="/about">
                {t.about.fullProfile}
              </CyberBtn>
            </m.div>
          </div>
                ...
                {about.skillGroups.map((group, gi) => (
                  ...
                  >
                    <div
                      ...
                      style={{ fontFamily: '"Play", sans-serif', color: 'var(--color-accent)' }}
                    >
                      {group.title}
                    </div>
                ...
                {about.timeline.map((item, i) => (
                  ...
                  >
                    <dt
                      ...
                      style={{ fontFamily: '"Play", sans-serif', color: 'var(--color-fg-mute)', letterSpacing: '0.05em' }}
                    >
                      {item.period}
                    </dt>
                    <dd>
                      <div
                        ...
                        style={{ fontFamily: '"Play", sans-serif', color: 'var(--color-fg)' }}
                      >
                        {item.role}
                      </div>
                      <div className="text-[12px]" style={{ fontFamily: '"Play", sans-serif', color: 'var(--color-fg-dim)' }}>
                        {item.context}
                      </div>
                    </dd>
                  </m.div>
