export const cases = [
  ...
  },
  {
    ...
    whatThisShows:
      'I do not approach game design as isolated mechanics. I look at the full product structure: the loop, the player decisions, the progression, the screens, the documentation and the way the team understands what is being built. In this project, the value was not only in designing features. It was in creating the foundation that made the prototype easier to understand, build and discuss. That is the kind of design work I care about: systems with purpose, documentation that helps the team and product decisions that make the experience clearer.',
    whatThisShowsEs:
      'No abordo el Game Design como mecánicas aisladas. Miro la estructura completa del producto: el loop, las decisiones del jugador, la progresión, las pantallas, la documentación y la forma en que el equipo entiende lo que está construyendo. En este proyecto, el valor no estuvo solo en diseñar features. Estuvo en crear la base que hizo que el prototipo fuera más fácil de entender, construir y discutir. Ese es el tipo de trabajo de diseño que me interesa: sistemas con propósito, documentación que ayuda al equipo y decisiones de producto que hacen más clara la experiencia.',
    contentEs: {
      summary:
